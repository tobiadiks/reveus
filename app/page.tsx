...
export default function Home() {
  return (
    <main className="grid snap-y gap-y-4 overflow-y-auto snap-mandatory max-h-screen grid-rows-1   p-8 relative  bg-[#003929]">

      <div className='bg-transparent w-1/2 h-[0] snap-start rounded-lg'>

      </div>
      <div className='bg-[#124E3C] opacity-100 relative w-1/2 h-[90vh] snap-start rounded-xl py-4 px-8'>
        <div className=' h-5/6 w-full relative '>
          <Image fill style={{ objectFit: 'fill' }} alt='bubble'  src={'/bubble.png'} />
        </div>
      ...
      <div className='bg-[#124E3C] opacity-100 relative w-1/2 h-[90vh] snap-start rounded-xl py-4 px-8'>
        ...
        <div className=' h-5/6 w-full relative '>
          <Image fill style={{ objectFit: 'fill' }} alt='lady'  src={'/lady.png'} />
        </div>
      </div>
      <div className='bg-[#124E3C] opacity-100 relative w-1/2 h-[90vh] snap-start rounded-xl py-4 px-8'>
        <div className='text-white mb-4'>
        ...
        <div className=' h-5/6 w-full relative '>
          <Image fill style={{ objectFit: 'fill' }} alt='carrer'  src={'/carrer.png'} />
        </div>
      </div>
      <div className='bg-[#124E3C] opacity-100 relative w-1/2 h-[90vh] snap-start rounded-xl py-4 px-8'>
          <Image fill style={{ objectFit: 'fill' }} alt='bt'  src={'/bt.png'} />
      </div>
      <div className=' h-4 w-1/2 text-center text-white text-sm'>Made with  ❤️ &  💫</div>
      <div className='fixed top-8 left-1/2 w-1/2'>
